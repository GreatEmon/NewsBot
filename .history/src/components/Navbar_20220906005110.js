            ...
            >
              <ul className="navbar-nav ms-auto mb-2 mb-lg-0 ">
                 <li className="nav-item">
                  <NavL key={"home"} exact to="/" className="nav-link" aria-current="page">
                     Home
                  </NavL>
                </li> 
                ...
                <li className="nav-item"><Link key={"entertainment"}  to="/entertainment" className="nav-link" >Entertainment</Link></li>
