      ...
      <div className="container">
        ...
        <div className="row mt-3">
            {this.state.articles.map((element)=>{
                return(
                    <NewsItem key={element.url} title={element.title?element.title.slice(0,45):"Custom Title"} description={element.description?element.description.slice()} imgurl={element.urlToImage} newsurl={element.url}/>
                )
            })}
