  ...
  render() {
    return (
      ...
      <div className="container d-flex justify-content-between pb-4">
        <button type="button" class="btn btn-primary btn" onClick={handleNext}>&larr;Previous</button>
        <button type="button" class="btn btn-primary btn" onClick={handleNext}>Next&rarr;</button>
      </div>
      </>
    )
  }
