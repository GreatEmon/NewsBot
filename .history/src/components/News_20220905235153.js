...
export default class News extends Component {
    ...
    async componentDidMount(){
        let url =`https://newsapi.org/v2/top-headlines?country=us&category=${this.propscategory}&apiKey=c141dbcf8e8b4df99a231845da9c544a&page=1&pageSize=${this.props.pageSize}`;
    ...
    handlePrev =async ()=>{
        let url =`https://newsapi.org/v2/top-headlines?country=us&category=${this.propscategory}&apiKey=c141dbcf8e8b4df99a231845da9c544aa&page=${this.state.page - 1}&pageSize=${this.props.pageSize}`;
        let data =await fetch(url);
        let parsedata =await data.json();
        this.setState({
    ...
    handleNext =async ()=>{
        ...
        let url =`https://newsapi.org/v2/top-headlines?country=us&category=${this.propscategory}&apiKey=c141dbcf8e8b4df99a231845da9c544a&page=${this.state.page + 1}&pageSize=${this.props.pageSize}`;
        let data =await fetch(url);
        let parsedata =await data.json();
        this.setState({
            page: this.state.page + 1,
