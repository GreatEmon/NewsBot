          ...
          <div className="container">
            ...
            >
              <ul className="navbar-nav ms-auto mb-2 mb-lg-0 ">
                ...
                <li className="nav-item"><Link key={"general"}  to="/general" className="nav-link" aria-current="page">General</Link></li>
                <li className="nav-item"><Link key={"business"} eact to="/business" className="nav-link" aria-current="page">Business</Link></li>
