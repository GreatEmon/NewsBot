    ...
    return (
      <>
        <BrowserRouter>
         <Navbar />
        <Routes>
        <Route exact key={"home"} path="/"><News pageSize={12} category=""/></Route>
        <Route exact key={"home"} path="/general"><News pageSize={12} category="general"/></Route>
        <Route exact key={"home"} path="/business"><News pageSize={12} category="home"/></Route>
